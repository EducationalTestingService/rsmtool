...
def run_experiment(config_file_or_obj_or_dict, output_dir, overwrite_output=False):
    """
    ...
    (
        analyzed_config,
        analyzed_container,
    ) = analyzer.run_data_composition_analyses_for_rsmtool(
    ...
    (train_analyzed_config, train_analyzed_container) = analyzer.run_training_analyses(
        processed_container, processed_config
    )
