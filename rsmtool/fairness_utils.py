...
def write_fairness_results(fit_dictionary,
    ...
    ----------
    fit_dictionary: dict
        A dictionary of fitted models generated by get_fairness_analysis
    fairness_container: container.DataContainer
        A data container with the results of fairness analysis generated by get_fairness_analysis
    group: str
...
def get_fairness_analysis(df,
    ...
    """ 
    Compute fairness analyses described in Loukina et al. (2019) (www.aclweb.org)
