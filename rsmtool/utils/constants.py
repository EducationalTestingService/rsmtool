...
CHECK_FIELDS = {'rsmtool': {'required': ['experiment_id',
                ...
                'rsmxval': {'required': ['experiment_id',
                                         'model',
                                         'train_file'],
                            'optional': ['description',
                                         'folds',
...
INTERACTIVE_MODE_METADATA = {'experiment_id': {'label': 'Experiment ID',
                             ...
                             'test_file': {'label': 'Path to evaluation data file',
                                           'type': 'file'},
                             'folds': {'label': 'Number of cross-validation folds to use (<u>5</u>)',
                                       'type': 'integer'},
                             'folds_file': {'label': 'Optional file with custom folds (overrides # of folds)',
                                            'type': 'file'},
