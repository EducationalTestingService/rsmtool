...
class TestReporter(unittest.TestCase):
    ...
    def test_check_section_order_extra_sections(self):
        ...
        custom_sections = ["custom.ipynb"]
        subgroups = []
        section_order = general_sections + custom_sections + ["extra_section"]
        with self.assertRaises(ValueError):
            self.reporter.get_ordered_notebook_files(
                general_sections,
                custom_sections=custom_sections,
    ...
    def test_check_section_order(self):
        ...
        section_order = ["foobar"] + general_sections
        self.reporter.check_section_order(general_sections + custom_sections, section_order)
    ...
    def test_determine_chosen_sections_default_general_no_subgroups(self):
        ...
        chosen_sections = self.reporter.determine_chosen_sections(
            general_sections, custom_sections, subgroups
        )
    ...
    def test_determine_chosen_sections_custom_general_with_subgroups_and_custom(
        self,
    ):
        ...
        self.assertEqual(
            sorted(chosen_sections),
            sorted(general_sections + ["foobar"]),
        )
    ...
    def test_determine_chosen_sections_eval_custom_general_with_subgroups(
        self,
    ):
        general_sections = [
            "data_description",
    ...
    def test_determine_chosen_sections_rsmcompare_custom_general_with_subgroups(
        self,
    ):
        general_sections = ["feature_descriptives", "evaluation"]
        custom_sections = []
    ...
    def test_determine_chosen_sections_compare_custom_general_with_subgroups_and_custom(
        self,
    ):
        general_sections = ["feature_descriptives", "evaluation"]
        custom_sections = ["foobar.ipynb"]
    ...
    def test_get_section_file_map_rsmtool(self):
        ...
        section_file_map = self.reporter.get_section_file_map(custom_sections, model_type="R")
    ...
    def test_get_section_file_map_rsmeval(self):
        custom_sections = ["/path/notebook.ipynb"]
        section_file_map = self.reporter.get_section_file_map(custom_sections, context="rsmeval")
        self.assertEqual(
    ...
    def test_get_section_file_map_rsmcompare(self):
        custom_sections = ["/path/notebook.ipynb"]
        section_file_map = self.reporter.get_section_file_map(custom_sections, context="rsmcompare")
        self.assertEqual(
    ...
    def test_get_section_file_map_rsmsummarize(self):
        ...
        section_file_map = self.reporter.get_section_file_map(
            custom_sections, context="rsmsummarize"
        )
        self.assertEqual(
            section_file_map["evaluation"],
